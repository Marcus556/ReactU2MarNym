...
class CardComponent extends Component {
  ...
  showInfo = () => {!this.state.showInfo ? this.setState({showInfo: true}) : this.setState({showInfo: false})}
    ...
    return (
      <div className={styles.wrapper}>
        <div className={styles.cardHolder}>
          ...
          <button type="button" className="btn btn-danger btn-block" onClick={this.showInfo}>{this.state.showInfo ? 'Hide info' : 'Show info'}</button> 
